package com.team3._8.game.lwjgl3;
...
public class Lwjgl3Launcher {
  ...
  private static void createApplication() {
    new Lwjgl3Application(new MazeGame(), getDefaultConfiguration());
  }

  private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
    Lwjgl3ApplicationConfiguration configuration = new Lwjgl3ApplicationConfiguration();
    configuration.setTitle("Maze Game");
    ...
    // be useful for testing performance, but can also be very stressful to some hardware.
